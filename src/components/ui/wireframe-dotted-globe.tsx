...
const colombiaPoints = [
  { lat: 4.711, lng: -74.0721, size: 0.8 }, // Bogotá
  { lat: 6.2442, lng: -75.5636, size: 0.6 }, // Medellín
  { lat: 3.4516, lng: -76.532, size: 0.5 }, // Cali
  { lat: 10.9685, lng: -74.7813, size: 0.5 }, // Barranquilla
  { lat: 10.391, lng: -75.5144, size: 0.5 }, // Cartagena
...
export default function RotatingEarth({
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-full aspect-square cursor-move overflow-hidden rounded-full", className)}
